...
class AsyncHttpTransportLoadTestMultiJvmClient extends ServiceRegistryModule with WordSpec with MustMatchers
  ...
  "A Sontatype AsyncHttpClient transport" should {
    behave like httpTransportUnderLoadMultiJvm("AsyncHttpTransportLoadTestMultiJvm", Port)
  }
}
